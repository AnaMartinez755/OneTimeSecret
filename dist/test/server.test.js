...
describe("POST /api/secrets", function () {
  describe("post a message", function () {
    ...
    test("should respond with a 201 status code for successful message creation", function () {
    ...
    test("should respond with a 404 status code if the endpoint is not found", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
          switch (_a.label) {
